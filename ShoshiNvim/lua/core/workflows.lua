...
vim.keymap.set('n', '<leader>os', ':Telescope find_files search_dirs={"~/obsedian/NGNl/"}<cr>')
vim.keymap.set('n', '<leader>oz', ':Telescope live_grep search_dirs={"~/obsedian/NGNl/"}<cr>')
--
...
vim.keymap.set('n', '<leader>ok', ":!mv '%:p' /Users/pantorn/obsedian/NGNl/workspace/my-templates-folder/<cr>:bd<cr>")
